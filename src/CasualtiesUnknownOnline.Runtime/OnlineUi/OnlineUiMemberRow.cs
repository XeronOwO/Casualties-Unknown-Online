...
public sealed class OnlineUiMemberRow
{
	...
	/// <summary>True when this non-local, in-world member is visible to the local player and has cached character data, so the read-only medical panel can be opened.</summary>
