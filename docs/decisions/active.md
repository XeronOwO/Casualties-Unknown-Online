...
| 137 | Pre-release protocol numbering was reset; `ProtocolVersion.Current` is bumped on behavioral wire changes (currently 8 after the building-entity red HitFlash presentation field addition). | `docs/architecture/protocol.md`, `docs/api/mod-api.md` |
