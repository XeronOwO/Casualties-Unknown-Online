...
玩家和模组作者要用的内容,按阅读顺序排好。英文版块是这棵树的完整镜像:
...
2. **做一件事** —— `how-to/`:一件事一页,有步骤、有能跑的例子,还有常见坑。
...
架构、决策、证据与 backlog 是贡献者向的资料,正在被重写进这两棵文档树。在重写完成之前,可用的入口是
[`../architecture/current.md`](../architecture/current.md)、[`../api/mod-api.md`](../api/mod-api.md)、
[`../decisions/active.md`](../decisions/active.md) 与 [`../backlog/README.md`](../backlog/README.md)。
