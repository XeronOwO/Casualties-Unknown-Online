...
[> `architecture-evolution/README.md`](../architecture/README.md),
[> `architecture-evolution/current-architecture.md`](../architecture/current.md),
...
| §5 Mod API / Microsoft.Extensions | `docs/api/mod-api.md`, `docs/decisions/active.md` |
| §7 Host migration | `docs/backlog/README.md` (not planned) |
...
> The "message envelope" sketched above predates the 2026-08-07 star-topology decision (pure star, **no envelope** — see docs/decisions/active.md "Wire transport"); the section below is the live model.
...
`docs/api/mod-api.md`.
Mod-state saves are landed (host-persistent `IModState`, see `docs/api/mod-api.md` §4d),
the local mod UI surface is landed (`IModUi`, see `docs/api/mod-api.md` §4e),
content registration is landed (`IModContent`, see `docs/api/mod-api.md` §4f),
ReadGameState is landed (`IModGameState`, see `docs/api/mod-api.md` §4g), entity
spawn is landed (`IModEntitySpawn`, see `docs/api/mod-api.md` §4h), and
AccessNativeApi is landed as a curated operation registry (`IModNativeApi`,
see `docs/api/mod-api.md` §4i). The Phase 4 Mod API surface is now complete except
...
[items remain future work in `backlog.md`](../backlog/README.md).
