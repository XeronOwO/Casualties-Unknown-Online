...
- Related: `todo/enemy-hit-determination-local.md` (the same authority rule for hits), `todo/concurrent-medical-operations.md` (the reservations half of the same services), `review/remote-medical-panel-acceptance-issues.md`
