...
/// owns it, and what a cut does with it. The table is documentation AND
/// enforcement — <see cref="WorldTransientPolicy.Rows"/> is the single place a
/// verdict is decided, and the contract test pins every row of the ticket's
/// table so a new in-flight state cannot be added without a verdict.
/// </summary>
