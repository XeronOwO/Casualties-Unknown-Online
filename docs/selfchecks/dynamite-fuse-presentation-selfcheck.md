...
| 3 | The explosion event carries the one-shot item id + position and replays the body/visual explosion | DynamiteExplosionMsg.cs; DynamiteExplosionSync.cs; docs/tech-decisions.md #40 |
...
- Touched: `CustomItemDataState.cs`, `ItemStateCodec.cs`,
  ...
  `RemoteItemPresentationTests.cs`, `docs/item-features.md`,
  `docs/backlog.md`, `docs/tech-decisions.md` (#53).
