...
| 137 | Pre-release protocol numbering was reset; `ProtocolVersion.Current` is bumped on behavioral wire changes (currently 15 after the `CharacterSoundKind.ItemPlacement` extension). | `docs/architecture/protocol.md`, `docs/api/mod-api.md` |
