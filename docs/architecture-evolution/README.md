...
> See [status.md](status.md), `docs/selfchecks/phase-e-legacy-inventory-selfcheck.md`,
> and `docs/tech-decisions.md` #158.
...
| [templates/phase-session.md](templates/phase-session.md) | Reusable historical phase-session template. |
| [phase-a-shadow-kernel.md](phase-a-shadow-kernel.md) | Phase A history. |
| [phase-b-items-authority.md](phase-b-items-authority.md) | Phase B history. |
| [phase-c-protocol-save-switch.md](phase-c-protocol-save-switch.md) | Phase C history. |
| [phase-d-full-domain-migration.md](phase-d-full-domain-migration.md) | Phase D history. |
| [phase-e-delete-dual-architecture.md](phase-e-delete-dual-architecture.md) | Phase E history. |
| [migration-roadmap.md](migration-roadmap.md) | Completed migration route/history. |
...
1. Read [current-architecture.md](current-architecture.md) for the current design.
2. Read [domains.md](domains.md) and [protocol.md](protocol.md) for the layer you are touching.
3. For historical context, read the relevant phase doc or [status.md](status.md).
4. For evidence, read `docs/verification.md` and the matching `docs/selfchecks/` sheet.
