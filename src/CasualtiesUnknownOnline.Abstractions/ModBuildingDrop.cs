...
/// <summary>
/// One authored drop entry for a custom building entity. It is a plain data
/// contract in Abstractions: no game type, no Unity type, no Runtime dependency.
/// The Game Adapter resolves the item id through the existing custom-item/prefab
/// seam and stores the converted vanilla <c>ItemDrop</c> on the runtime
/// template, so the vanilla building destruction path can spawn authored drops.
/// </summary>
[DataContract]
public sealed class ModBuildingDrop
{
