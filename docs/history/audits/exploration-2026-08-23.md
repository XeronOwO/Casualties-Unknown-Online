...
belong in `docs/decisions/active.md`; actionable open items are summarized in
...
- **Landed**: a new host→guest `RadiationLineStateMsg` (NetMsg 106,
  ...
  `WorldGenerationUpdatePatch`. See `docs/evidence/selfchecks/world/radiation-line-state-sync-selfcheck.md`
  and `docs/decisions/active.md` #55.
...
- **Landed**: `CrystalTeleportTriggered` (EntityEventKind 33, ProtocolVersion
  ...
  no latch). See `docs/evidence/selfchecks/enemies/crystal-teleport-sync-selfcheck.md` and
  `docs/decisions/active.md` #56.
...
- **Landed**: `RemoteBodyFactory.CreateRemoteBody` now disables every
  ...
  `docs/evidence/selfchecks/presentation/owner-local-body-auto-events-selfcheck.md` and
  `docs/decisions/active.md` #57.
...
> `docs/evidence/selfchecks/enemies/trader-recruit-selfcheck.md` and
> `docs/evidence/selfchecks/items/trader-recruit-gift-items-selfcheck.md`.
...
- **Landed**: `RespawnOptions` (BepInEx `[Respawn]` rules, hot-reloadable),
  ...
  the world. No protocol change. See `docs/evidence/selfchecks/players/respawn-rules-selfcheck.md`
  and `docs/decisions/active.md` #60.
...
- **Landed**: the world-state half landed earlier (NetMsg 106, #55); the
  ...
  `docs/evidence/selfchecks/world/radiation-straggler-pressure-selfcheck.md` and
  `docs/decisions/active.md` #58.
...
> `docs/evidence/selfchecks/session/host-rules-selfcheck.md` and `docs/decisions/active.md` #74.
...
> `docs/evidence/selfchecks/ui/chat-selfcheck.md` and `docs/decisions/active.md` #61.
...
- Admin commands / kick / ban / vote-kick — medium value for friend sessions;
  ...
  landed as closed slices (see `docs/evidence/selfchecks/session/host-kick-selfcheck.md` and
  `docs/evidence/selfchecks/session/host-ban-selfcheck.md`); vote-kick remains open.
- Co-op keybinds, push/piggyback, status icons, richer player list — functional
  ...
  slices (see `docs/evidence/selfchecks/players/player-push-selfcheck.md`).
...
> See `docs/evidence/selfchecks/players/online-ui-player-awareness-selfcheck.md`.
...
> listed in `docs/backlog/README.md` as the follow-up "large logical class debt
> flattening" item. See `docs/evidence/selfchecks/tooling/partial-aware-gate-selfcheck.md` and
> `docs/decisions/active.md` #65.
...
> `docs/evidence/selfchecks/protocol/netmsg-registry-selfcheck.md` and
> `docs/decisions/active.md` #63.
...
- **Landed**: `Session/HandlerContexts/` capability interfaces +
  ...
  `docs/evidence/selfchecks/tooling/handler-context-narrowing-selfcheck.md` and
  `docs/decisions/active.md` #73.
...
> state. See `docs/evidence/selfchecks/world/world-entry-completion-selfcheck.md` and
> `docs/decisions/active.md` #64.
...
- **Landed**: the periodic paths moved to Debug/Verbose — 1 Hz character
  ...
  `docs/evidence/selfchecks/tooling/log-level-cleanup-selfcheck.md`.
