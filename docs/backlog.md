...
- **EnemyCombatOrderPolicy kernel-process follow-up** — the extracted
  ...
  local-apply command for now. See `docs/selfchecks/phase-e-legacy-inventory-selfcheck.md`.
- **Generic Prediction Runtime — future architecture work (deferred from Phase D
  ...
  (`docs/tech-decisions.md` #157). A unified prediction/rollback runtime for local
