...
| Next work session | Continue Phase D: absorb `EnemyCombatDirector`/targeting into kernel processes, fluid guest local simulation as a rebuildable projection, or 4.2 Traps/Building Entities; keep `EnemyAttackMsg` and push presentation-only. |
