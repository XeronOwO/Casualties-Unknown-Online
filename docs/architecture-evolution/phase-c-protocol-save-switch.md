...
| 2026-08-28 | Phase C StateStream cycle: item move host→guest now rides `StateStreamEnvelope` and resurface as `ItemMoveReceived`; disconnect/reconnect checkpoint-restore test added. | `809a808` | Full suite 1644 tests green; architecture/event/entity gates pass. | Remaining: old item families use/slot/container/correction/carry/snapshot/cook, failed-projection test, final docs/tech-decisions. |
