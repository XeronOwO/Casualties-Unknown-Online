...
- [x] Update existing docs:
  - this phase doc, `status.md`, `docs/evidence/selfchecks/architecture/phase-b-item-authority-selfcheck.md`;
  - `docs/decisions/active.md` with the authority-switch decision and evidence;
  - `docs/architecture/README.md` phase table.
...
- Record all binding item-domain decisions in `docs/decisions/active.md`.
