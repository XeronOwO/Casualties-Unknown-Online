...
- Declare permissions and host commands — *being written*
- Read game state — *being written*
- Add a panel to the interface — *being written*
- Register content — *being written*
- Save mod data across sessions — *being written*
- Decide which side judges an action — *being written*
