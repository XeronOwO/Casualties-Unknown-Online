...
/// proxy is presentation-only; legitimate release outcomes are the
/// remote-backpack take path and the Tab-switch transfer path (release into the
/// local inventory after the remote view closed). If neither path consumed it,
