...
Compressed record of the architecture-evolution decisions (#126–#158). Full prose is in git history; the active normative subset is in `docs/tech-decisions.md`.

## Phase A — Shadow kernel

> Evidence: docs/selfchecks/phase-a-kernel-foundation-selfcheck.md
...
> Evidence: docs/selfchecks/phase-b-item-authority-selfcheck.md
...
> Evidence: docs/selfchecks/phase-c-protocol-core-selfcheck.md
...
> Evidence: docs/selfchecks/phase-d-full-domain-migration-selfcheck.md
...
> Evidence: docs/selfchecks/phase-e-legacy-inventory-selfcheck.md
