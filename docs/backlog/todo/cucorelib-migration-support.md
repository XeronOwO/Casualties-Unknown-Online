...
- `ModStatusProjectionKind` + `ModBodyFormulaProjection` +
  ...
  bleed/skin/muscle/infection fields. The vanilla moodle row remains a future
  seam. No game/Unity type crosses
