...
- **[中文文档](zh/README.md)** —— 从这里开始、做一件事、弄懂原理、查东西、参与开发

## English

- **[English documentation](en/README.md)** — start here, do one thing, understand why, look something
  up, work on CUO itself
