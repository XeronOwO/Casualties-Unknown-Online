...
| 5 | The limb presentation cycle recorded the residual explicitly | `docs/evidence/selfchecks/players/limb presentation selfcheck.md` accepted residuals |
...
## 4. Verification
  ...
  New tests:
    ...
    `NetPacketTests.CharacterData_EveryFieldFamily_RoundTrips` full-field round-trip assertions
