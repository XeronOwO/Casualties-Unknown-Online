...
| 137 | Pre-release protocol numbering was reset; `ProtocolVersion.Current` is bumped on behavioral wire changes (currently 6 after the head/mouth presentation field addition). | `docs/architecture/protocol.md`, `docs/api/mod-api.md` |
