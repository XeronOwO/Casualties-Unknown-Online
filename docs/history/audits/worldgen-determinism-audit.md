...
[`docs/backlog/README.md`](../../backlog/README.md) under Final acceptance.
...
- The per-side `Start` divergences that remain are either already covered by
  ...
  recorded as accepted gaps in `docs/backlog/README.md`.
...
| Accepted visual/timing gaps | backlog record only | `docs/backlog/README.md` presentation gaps + accepted exclusions |
