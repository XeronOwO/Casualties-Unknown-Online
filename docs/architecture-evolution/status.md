...
| Next work session | Continue Phase D: the next domain restore/snapshot projection cleanup (fluid/other restore paths) or the next authority-switch sub-step; keep push presentation-only. |
