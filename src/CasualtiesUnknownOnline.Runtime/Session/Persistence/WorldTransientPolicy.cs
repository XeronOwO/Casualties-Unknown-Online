...
public static class WorldTransientPolicy
{
	...
	[
		new(BlockBreakPendingKey, "BlockBreakPendingState", WorldTransientVerdict.ResolveBeforeSave, WorldTransientDetection.Observed,
		...
		new(MedicalSessionKey, "MedicalOperationSessionService", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Observed,
		...
		new(ShrapnelSessionKey, "ShrapnelOperationSessionService", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Observed,
		...
		new(OtherMedicalSessionKey, "OtherMedicalOperationSessionService", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Observed,
			"other medical operation(s) in progress",
			"Same split as medical: the bandage/splint/tourniquet result is a kernel fact."),
		new(CraftBatchKey, "game craft coroutine", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Standing,
		...
		new(DeferredEntityReportKey, "RuntimeEntityChannel", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Observed,
		...
		new(ItemPhysicsKey, "item motion path", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Standing,
		...
		new(DecidedNativeValuesKey, "NativeWorldFacts", WorldTransientVerdict.Capture, WorldTransientDetection.Observed,
		...
		new(WorldClockKey, "native run fields", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Standing,
			"world-clock state",
		...
		new(EarthquakeTimersKey, "WorldGeneration countdown fields", WorldTransientVerdict.DropWithLog, WorldTransientDetection.Standing,
			"earthquake timer(s)",
