...
- **Random trader items landed separately**: this first slice was the minimal
  ...
  `docs/evidence/selfchecks/items/trader-recruit-gift-items-selfcheck.md` and
  `docs/decisions/active.md` #62.
- **Death is still not a full respawn system here**: this slice covers a dead
  ...
  `docs/evidence/selfchecks/players/respawn-rules-selfcheck.md` and `docs/decisions/active.md` #60.
