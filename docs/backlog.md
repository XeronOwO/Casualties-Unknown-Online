...
- **Cross-player item use (give/feed/drink/wear/use an item on another player)** — **CLOSED (through timed/random injectable liquid medicine, 2026-08-25)**. Host-authoritative `PlayerItemUseRequest`/`PlayerItemUseResult` (NetMsg 116/117, ProtocolVersion 48) covers drink/food, curated injectables, topical `ApplyToLimb`, opiates/antagonists, component medicine, limb tools, component-bearing tools, native wearable placement, shrapnel/timed tools, and timed/random injectable liquid medicine (`TimedBodyEffects`, additive). Remaining: drinkable timed/random/component medicine branches (antirad, sleepingpills, painkillers, antibiotics, antidepressants, braingrow, mindwipe, keratinbooster, naltrexone, and other onDrink branches). See `docs/tech-decisions.md` #96-#109.
