...
| 2 | Painkillers component wire state | `CharacterHealthMsg.OpiateAmount` (ProtoMember 68) + `PainkillersSync` (see `docs/decisions/active.md` #102) |
...
| Local apply | `CharacterDataSync.ApplyHealState` + `PainkillersSync.Apply` writes the component on the target body | existing opiate slice evidence (`docs/decisions/active.md` #102) |
