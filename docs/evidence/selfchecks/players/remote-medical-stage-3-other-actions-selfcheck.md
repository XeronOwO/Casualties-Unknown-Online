...
| 4 | Dislocation fix was exclusive-limb-leased at this stage (superseded 2026-09-19 by per-unit settlement — see `review/concurrent-medical-operations.md`); hits report to host and success commits `Dislocated=false` | `OtherMedicalOperationSessionService` reservation, `OtherMedicalOperationApplier.ApplyDislocationHit/CompleteDislocation`, `DislocationCheckForHitPatch` |
