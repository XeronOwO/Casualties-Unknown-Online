...
- Status: Resolved (absorbed 2026-09-20 into `todo/application-layer-first-slice.md`)
...
`todo/application-layer-first-slice.md`: one place that binds the actor to the transport sender,
