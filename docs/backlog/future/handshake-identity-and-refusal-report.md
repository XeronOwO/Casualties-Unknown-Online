...
- Related: `docs/en/reference/mod-api.md` (Handshake consistency, Versioning discipline), `docs/en/reference/modification-policy.md`, `review/mod-api-contract-governance.md`
