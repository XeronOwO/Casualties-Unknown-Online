...
/// the item table; Phase D adds World/Run, WorldEntities, Players, and Entities
/// baselines and later phases add every remaining domain table. Random streams
/// are optional and empty until a domain actually owns one.
/// </summary>
