...
[4. Read current-architecture.md](../current.md) for the current model.
...
7. Read any relevant existing docs:
   - `docs/decisions/active.md` for landed binding decisions;
   - `docs/selfchecks/` for recent delivery evidence;
   - `docs/backlog/README.md` for open work;
...
- Record every binding decision in `docs/decisions/active.md` with commit evidence and
...
2. Create/update the phase fact sheet under `docs/selfchecks/` with:
   ...
   - structure review.
3. Add all binding decisions to `docs/decisions/active.md`.
