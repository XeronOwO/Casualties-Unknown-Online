...
> Canonical per-entity sync status: [`entity-features.md`](entity-features.md).
...
and `docs/architecture-evolution/protocol.md`.
...
- Phase D self-check:
  `docs/selfchecks/phase-d-enemies-shadow-selfcheck.md`
- Phase D full migration:
  `docs/selfchecks/phase-d-full-domain-migration-selfcheck.md`
